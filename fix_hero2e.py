...
css_block = (
    ...
    # Increase hero height so buttons clear the dark section overlap (-144px)
    "\t.vc_custom_1001{min-height:880px !important;}\n"

    # Responsive left alignment matching header logo
    "\t.vc_custom_1002{\n"
    ...
    # Inner button row: flush, flexbox so all 3 columns stretch to equal height
    ...
    # Button container: stretch to full column height
    "\t.vc_custom_1001 .vc_inner .vc_btn3-container{\n"
    "\t\tdisplay:flex !important;\n"
    "\t\tflex:1 !important;\n"
    "\t}\n"

    # Button: fill container, centered, allow wrapping so text stays inside
