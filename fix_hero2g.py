...
css_block = (
    ...
    # Right column image: match hero height, anchor woman to bottom
    "\t.vc_custom_1004{\n"
    ...
    # Left column: responsive alignment + breathing room
    "\t.vc_custom_1002{\n"
    ...
    "\t\t.vc_custom_1004{min-height:300px !important;background-position:top center !important;}\n"
    "\t\t.vc_custom_1002{\n"
